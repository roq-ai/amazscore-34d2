      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'amaz_score',
              isInvalid: !!formik.errors?.amaz_score,
            }}
            name="amaz_score"
            error={formik.errors?.amaz_score}
            value={formik.values?.amaz_score}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('amaz_score', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
